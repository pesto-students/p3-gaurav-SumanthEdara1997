...
app.post('/', function(req, res) {
    ...
    let url = `http://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=3436c332abbccea9a37879dabc623e77`;
...
// url localhost:5000   
// from the above url we will get the weather details we need to enter the city name to get the details
